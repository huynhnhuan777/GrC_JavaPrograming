...
const Tour = () => {
    ...
    // Hàm gọi dữ liệu từ sessionStorage
    useEffect(() => {
        const savedData = sessionStorage.getItem('farmData'); // Lấy dữ liệu từ sessionStorage
        if (savedData) {
            const parsedData = JSON.parse(savedData);
            setTourData(parsedData.info); // Gán dữ liệu 'info' vào state
            console.log("Dữ liệu được tải từ sessionStorage:", parsedData);
        } else {
